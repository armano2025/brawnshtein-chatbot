...
const BoostFlow = (() => {
  ...
  function stepPlan(){
    ...
    if(isHigh5){
      ...
      note.textContent='ברמת יא/יב 5 יח"ל ניתן לבחור רק מסלול טריפל או מסלול פרטי.';
  ...
  function stepStudentName(){
    ...
    Chat.botHTML('<strong>שם התלמיד/ה</strong><br><span class="muted">למי מיועד שיעור התגבור?</span>');
